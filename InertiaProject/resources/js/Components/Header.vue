    ...
    <header class="bg-white">
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                <Link class="text-sm font-semibold leading-6 text-gray-900" href="/listing">Listing Page</Link>
                <Link class="text-sm font-semibold leading-6 text-gray-900" href="/create">Creation Page</Link>
            </div>
